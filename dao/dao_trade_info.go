...
func (d *DbDao) StartAccountSale(accountInfo TableAccountInfo, tradeInfo TableTradeInfo, transactionInfo TableTransactionInfo) error {
	return d.db.Transaction(func(tx *gorm.DB) error {
		...
		if err := tx.Clauses(clause.OnConflict{
			DoUpdates: clause.AssignmentColumns([]string{"block_number", "outpoint", "owner_algorithm_id", "owner_chain_type", "owner_address", "description", "started_at", "block_timestamp", "price_ckb", "price_usd", "profit_rate", "status"}),
